...
uTrimap =
  ...
  where f x = replicate x '*'
        ...
        mytrimap1 =
          trimap :: (Int -> Int) -> (String -> String) -> (String -> String) -> ISSTree -> ISSTree
        mytrimap2 =
          trimap :: (Int -> String) -> (String -> String) -> (String -> String) -> ISSTree -> SSSTree
        mytrimap3 =
          trimap :: (Int -> Int) -> (String -> String) -> (String -> String) -> ISSTree -> ISSTree
        mytrimap4 =
          trimap :: (Int -> String) -> (String -> String) -> (String -> String) -> ISSTree -> SSSTree
