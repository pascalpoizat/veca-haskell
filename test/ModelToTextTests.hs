...
unittests :: TestTree
unittests = testGroup "Unit tests" [uFoldMapToString, uFoldMapToString']
...
uFoldMapToString = testGroup
  "Unit tests for foldMapToString"
  [ testCase "empty list"
  $   foldMapToString "{" ", " "}" f1' (head dataProvider1)
  @?= ""
  , testCase "list of length 1"
  $   foldMapToString "{" ", " "}" f1' (dataProvider1 !! 1)
  @?= "{3}"
  , testCase "list of length >1"
  $   foldMapToString "{" ", " "}" f1' (dataProvider1 !! 2)
  @?= "{3, 5, 7, 9}"
  , testCase "empty set"
  $   foldMapToString "{\n" "\n" "\n}" f2' (head dataProvider2)
  @?= ""
...
uFoldMapToString' = testGroup
  ...
  $   foldMapToString' ", " f1' (dataProvider1 !! 2)
  @?= "3, 5, 7, 9"
  , testCase "empty set" $ foldMapToString' "\n" f2' (head dataProvider2) @?= ""
  , testCase "set of size 1"
  $   foldMapToString' "\n" f2' (dataProvider2 !! 1)
  @?= "-3-"
  , testCase "set of size >1"
