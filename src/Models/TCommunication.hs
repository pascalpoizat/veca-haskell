...
Description : A class for communication (input-output) events with internal events.
...
{-|
A class for communication (input-output) events with internal events.
